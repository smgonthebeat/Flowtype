...
普通用户不需要安装 Swift 或自己编译。请只从官方 [`v0.1.0-preview.1` Release](https://github.com/smgonthebeat/Flowtype/releases/tag/v0.1.0-preview.1) 下载 `Flowtype.dmg`，打开后把 `Flowtype.app` 拖进 Applications。
